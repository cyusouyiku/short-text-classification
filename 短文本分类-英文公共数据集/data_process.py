...
class DataProcessor:
    ...
    def load_datasets(self):
        ...
        train_path = '/Users/zhangzongyu/Desktop/短文本分类/短文本分类-英文公共数据集/data/ag_news_train_labeled.txt'
        test_path = '/Users/zhangzongyu/Desktop/短文本分类/短文本分类-英文公共数据集/data/ag_news_test_labeled.txt'
