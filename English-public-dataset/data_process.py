...
class DataProcessor:
    ...
    def load_datasets(self):
        ...
        train_path = os.path.join(base, 'ag_news_train_labeled.txt')
        test_path = os.path.join(base, 'ag_news_test_labeled.txt')
        if not os.path.exists(train_path):
            train_path = os.path.join(self.data_dir, 'ag_news_train_labeled.txt')
        if not os.path.exists(test_path):
            test_path = os.path.join(self.data_dir, 'ag_news_test_labeled.txt')
