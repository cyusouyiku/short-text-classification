...
# Define class mapping (from README)
CLASS_NAMES = [
    "Civil/Livelihood",  # 100
    "Culture",           # 101
    "Entertainment",     # 102
    "Sports",            # 103
    "Finance",           # 104
...
def parse_args():
    ...
    parser.add_argument('--lr', type=float, default=0.003, help='Learning rate (paper Table 4)')
    parser.add_argument('--num_epochs', type=int, default=50, help='Number of training epochs (paper Table 4)')
...
def main():
    ...
    # Create dataloaders - pass raw texts for RoBERTa tokenization
    def collate_fn(batch):
        return processor.preprocess_batch(
    ...
    # Model configuration - RoBERTa + Word2Vec + Positional embeddings
    model_config = {
