...
class CapsuleNet(nn.Module):
    ...
    def __init__(self, embedding_dim, num_primary_units=8, 
        ...
        # No embedding layer - receives pre-computed embeddings from unified layer
    ...
    def forward(self, x, attention_mask=None):
        # x is pre-computed embeddings (batch_size, seq_len, embedding_dim) from unified layer
        batch_size = x.size(0)
